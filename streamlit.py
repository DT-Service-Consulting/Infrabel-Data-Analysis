...
st.markdown("""
Using predictive modeling, it was found that having ETCS has an **significant impact (of approximately 27%)** on predicting delay times. (Technical details: R-squared = 0.58).
